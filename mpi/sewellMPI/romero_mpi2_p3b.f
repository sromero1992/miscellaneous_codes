...
C                              REDUCTION TO ROW ECHELON FORM
      CALL PREDQ(A,M,N,B_,PIVOT,NPIVOT,ERRLIM)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE PREDQ(A,M,N,B,PIVOT,NPIVOT,ERRLIM)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C                              DECLARATIONS FOR ARGUMENTS
      DOUBLE PRECISION A(M,*),B(M),ERRLIM,COL(M)
...
C                              PREMULTIPLY A BY Qij**T
            DO 5 K=L0,N,NPES
               BIK = C*A(I,(K-1)/NPES+1) + S*A(J,(K-1)/NPES+1)
               BJK =-S*A(I,(K-1)/NPES+1) + C*A(J,(K-1)/NPES+1)
               A(I,(K-1)/NPES+1) = BIK
               A(J,(K-1)/NPES+1) = BJK
    5       CONTINUE
